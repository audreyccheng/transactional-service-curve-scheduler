...
public abstract class ClientBase extends BaseNode {
  ...
  public abstract void scheduleTransaction(int type) throws DatabaseAbortException;
  public abstract void scheduleTransactionFair(int type, int appId) throws DatabaseAbortException;
