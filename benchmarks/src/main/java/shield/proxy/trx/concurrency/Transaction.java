...
public class Transaction implements Comparable<Transaction> {
  ...
  public org.rocksdb.ReadOptions readOptions;
  public org.rocksdb.OptimisticTransactionOptions txnOptions;
  public org.rocksdb.Snapshot snapshot;
  public org.rocksdb.Transaction txnRDB;
  public int cluster;
  public int appId;
  ...
  public Transaction(long clientId) {
    ...
    // this.writeOptions.sync = true; // TODO(accheng): needed?
    this.readOptions = new ReadOptions();
    // this.txnOptions = new OptimisticTransactionOptions().setSetSnapshot(true);
    this.txnRDB = null;
    this.cluster = 0;
    this.appId = 0;
  }

  public void setTxn(org.rocksdb.Transaction txn) {
    this.txnRDB = txn;
  }

  public void putSnapshot(org.rocksdb.Snapshot snapshot) {
    this.snapshot = snapshot;
    this.readOptions.setSnapshot(snapshot);
  }

  public void clearSnapshot() {
    this.readOptions.setSnapshot(null);
  }
