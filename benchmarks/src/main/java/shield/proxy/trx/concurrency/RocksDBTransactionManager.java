...
public class RocksDBTransactionManager extends TransactionManager {
    ...
    */
    ...
    public void startTransaction(long clientId, Transaction t, int type, int appId) {
...
//        System.out.println("RocksDB SS2");
    ...
    public void onTransactionStarted(Transaction trx, boolean success) {
        ...
        boolean succ = success;
         System.out.println("onTransactionStarted cluster: " + trx.cluster + " appId: " + trx.appId);
       try {
           if (trx.cluster != 0 && trx.appId != 0) { // TBU
               trx.txnRDB.scheduleFair(trx.cluster, trx.appId);
           } else if (trx.cluster != 0) {
           ...
           trx.readOptions.setSnapshot(trx.snapshot);
            ...
            succ = true;
              System.out.println("TransactionScheduled cluster: " + trx.cluster);
       } catch (RocksDBException err) {
