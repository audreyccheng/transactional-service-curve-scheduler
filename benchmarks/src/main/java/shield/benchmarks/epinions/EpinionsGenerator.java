...
//       System.out.println("[" + Transactions.DEPOSIT_CHECKING+ "] End");
            ...
            trx = GenerateUpdateUserName(clientId);
//      System.out.println("[" + Transactions.DEPOSIT_CHECKING+ "] Begin");
            nbAborts = trx.run();
            end = System.currentTimeMillis();
//       System.out.println("[" + Transactions.DEPOSIT_CHECKING+ "] End");
            ...
            trx = GenerateUpdateItemTitle(clientId);
//      System.out.println("[" + Transactions.DEPOSIT_CHECKING+ "] Begin");
            nbAborts = trx.run();
            end = System.currentTimeMillis();
//       System.out.println("[" + Transactions.DEPOSIT_CHECKING+ "] End");
            ...
            trx = GenerateUpdateReviewRating(clientId);
//      System.out.println("[" + Transactions.DEPOSIT_CHECKING+ "] Begin");
            nbAborts = trx.run();
            end = System.currentTimeMillis();
//       System.out.println("[" + Transactions.DEPOSIT_CHECKING+ "] End");
            ...
            trx = GenerateUpdateTrustRating(clientId);
...
//       System.out.println("[" + Transactions.WRITE_CHECK+ "] End");
            ...
            trx = GenerateUpdateItemAvg(clientId);
            nbAborts = trx.run();
            end = System.currentTimeMillis();
    ...
    public UpdateUserNameTransaction GenerateUpdateUserName(int clientId) {
        // int uid = rand.nextInt(num_users);
        int uid = this.userRecord.nextValue();
        String title = RandString(config.NAME_LENGTH, config.NAME_LENGTH, false);
        return new UpdateUserNameTransaction(this,uid,title,txn_id++,clientId);
    }

    public UpdateItemTitleTransaction GenerateUpdateItemTitle(int clientId) {
        // int iid = rand.nextInt(num_items);
        int iid = this.itemRecord.nextValue();
        String title = RandString(config.TITLE_LENGTH, config.TITLE_LENGTH, false);
        return new UpdateItemTitleTransaction(this,iid,title,txn_id++,clientId);
    }

    public UpdateReviewRatingTransaction GenerateUpdateReviewRating(int clientId) {
        // int iid = rand.nextInt(num_items);
        int iid = this.itemRecord.nextValue();
        // int uid = rand.nextInt(num_users);
        int uid = this.userRecord.nextValue();
        int rating = rand.nextInt(1000);
        return new UpdateReviewRatingTransaction(this,iid,uid,rating,txn_id++,clientId);
    }

    public UpdateTrustRatingTransaction GenerateUpdateTrustRating(int clientId) {
        // int uid = rand.nextInt(num_users);
        int uid = this.userRecord.nextValue();
        int uid2 = rand.nextInt(num_users);
        int trust = rand.nextInt(2);
        return new UpdateTrustRatingTransaction(this,uid,uid2,trust,txn_id++,clientId);
    }

    public UpdateItemAvgTransaction GenerateUpdateItemAvg(int clientId) {
        // int iid = rand.nextInt(num_items);
        int iid = this.itemRecord.nextValue();
        String title = RandString(config.TITLE_LENGTH, config.TITLE_LENGTH, false);
        return new UpdateItemAvgTransaction(this,iid,title,txn_id++, clientId);
    }
