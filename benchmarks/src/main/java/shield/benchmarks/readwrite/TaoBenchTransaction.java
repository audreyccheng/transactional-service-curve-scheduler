...
public class TaoBenchTransaction extends BenchmarkTransaction{
  ...
  public TaoBenchTransaction(RWGenerator generator, int key, long txn_id, int clientId) {
...
//      System.out.println("TBTxn " + this.clientId);

      int p = Generator.generateInt(0,100);
      if (p > config.TAOBENCH_CONFLICT || this.clientId == 1) {
