...
static const std::string rocksdb_build_git_sha  = "rocksdb_build_git_sha:adc38e877a4eca4a49deccaaf1fd3867fe71b750";
static const std::string rocksdb_build_git_tag = "rocksdb_build_git_tag:fair-scheduling";
#define HAS_GIT_CHANGES 1
#if HAS_GIT_CHANGES == 0
// If HAS_GIT_CHANGES is 0, the GIT date is used.
// Use the time the branch/tag was last modified
static const std::string rocksdb_build_date = "rocksdb_build_date:2024-05-02 09:48:22";
#else
// If HAS_GIT_CHANGES is > 0, the branch/tag has modifications.
// Use the time the build was created.
static const std::string rocksdb_build_date = "rocksdb_build_date:2024-05-03 09:55:23";
#endif
